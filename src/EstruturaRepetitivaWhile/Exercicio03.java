...
public class Exercicio03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("A quantidade de alcool é:" + alcool);
		System.out.println("A quantidade de gasolina é:" + gasolina);
		System.out.println("A quantidade de diesel é:" + diesel);
